  ...
  return (
    <div className="space-y-8 pb-12">
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        {[
          { label: "Test Accuracy", value: "99.89%", icon: Activity, color: "text-emerald-600", bg: "bg-emerald-50" },
          { label: "Total Params", value: "211,299", icon: Cpu, color: "text-blue-600", bg: "bg-blue-50" },
          { label: "Classes", value: "24 ASL", icon: Grid3X3, color: "text-purple-600", bg: "bg-purple-50" },
          { label: "Latency", value: "~15ms", icon: Zap, color: "text-amber-600", bg: "bg-amber-50" },
        ].map((stat, i) => (
          <motion.div
            key={stat.label}
